...
// Emits a typed error hierarchy as a source string.
// Produces a base APIError class + response subclasses (BadRequestError,
// UnauthorizedError, ForbiddenError, NotFoundError, RateLimitError,
// InternalServerError, TimeoutError), two client-side subclasses
// (AuthError, ConfigError — constructed with a plain message by auth.ts), and a
// throwForResponse dispatcher.
...
export class TimeoutError extends APIError { constructor(a: ConstructorParameters<typeof APIError>[0]) { super(a); this.name = "TimeoutError"; } }
