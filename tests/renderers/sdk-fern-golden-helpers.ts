...
export type GoldenFixture = "rest" | "graphql" | "agent";
...
export function fernTreeName(lang: FernLang, fixture: GoldenFixture): string {
  if (fixture === "rest") return `sdk-${lang}-minimal`;
  if (fixture === "graphql") return `sdk-${lang}-graphql-minimal`;
  return `sdk-${lang}-agent-minimal`;
}
