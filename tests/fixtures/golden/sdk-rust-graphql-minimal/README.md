# Skillship Rust Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=Skillship%2FRust)
[![crates.io shield](https://img.shields.io/crates/v/skillship_api)](https://crates.io/crates/skillship_api)

The Skillship Rust library provides convenient access to the Skillship APIs from Rust.
...
```rust
match client.mutation.create_project(None)?.await {
    Ok(response) => {
...
```rust
let response = client.mutation.create_project(
